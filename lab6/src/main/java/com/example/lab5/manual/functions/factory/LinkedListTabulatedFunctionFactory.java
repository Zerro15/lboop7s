...
/**
 * Фабрика табулированных функций на основе связного списка.
 */
public class LinkedListTabulatedFunctionFactory implements TabulatedFunctionFactory {
    ...
    private TabulatedFunction build(double[] xValues, double[] yValues) {
        List<TabulatedPoint> points = new LinkedList<>();
